...
class neighborhoodTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('neighborhoods')->insert(['neighborhood'=>"Area Centro",'slug'=>"area-centro",'id_city'=>1]);
        ...
        DB::table('neighborhoods')->insert(['neighborhood'=>"Cerrito sur",'slug'=>"cerrito-sur",'id_city'=>1]);
            DB::table('neighborhoods')->insert(['neighborhood'=>"Cerrito y San Salvador",'slug'=>"cerrito-y-san-salvador",'id_city'=>1]);
        ...
        DB::table('neighborhoods')->insert(['neighborhood'=>"De la plaza Fortunato",'slug'=>"de-la-plaza-fortunato",'id_city'=>1]);
        DB::table('neighborhoods')->insert(['neighborhood'=>"Del puerto",'slug'=>"del-puerto",'id_city'=>1]);
        ...
        DB::table('neighborhoods')->insert(['neighborhood'=>"Parque hermoso y Valle hermoso",'slug'=>"parque-hermoso-y-valle-hermoso",'id_city'=>1]);
